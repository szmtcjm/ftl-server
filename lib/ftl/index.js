...
module.exports = function(req, res, next) {
  ...
  var getUrlMapVal = '';
  //实现自定义路由访问兼容直接访问文件路径
  if(/.*\.(ftl|js|css|jpg|png|gif)$/.test(req.path)){
    //直接访问.ftl文件
  ...
  var filePath = path.join(config.ftlBase, getUrlMapVal);
  function render() {
    if (/.*\.ftl$/.test(filePath)) {
      ftl.render(getUrlMapVal, {req: req, res: res}, function(stdout, stderr) {
